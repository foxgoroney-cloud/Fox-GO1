...
import 'package:fox_delivery_driver/features/order/screens/order_location_screen.dart';
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              DateConverterHelper.beforeTimeFormat(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              '${'payment'.tr} - ${orderModel.paymentMethod == 'cash_on_delivery'
                                  ? 'cod'.tr
                                        ...
                                        .then((isSuccess) {
                                          if (isSuccess) {
                                            ...
                                            orderModel.orderStatus =
                                                ...
                                                : orderModel.orderStatus;
                                            orderController
                                                .initializeOperationalFlow(
                                                  orderModel,
                                                );
                                            Get.toNamed(
                                              RouteHelper.getDeliveryOperationRoute(
                                                orderModel.id!,
                                              ),
                                            );
                                          } else {
