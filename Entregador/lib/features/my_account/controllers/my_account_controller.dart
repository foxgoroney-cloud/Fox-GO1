...
import 'package:fox_delivery_driver/api/api_checker.dart';
...
import 'package:fox_delivery_driver/features/my_account/domain/models/loyalty_point_model.dart';
...
import 'package:fox_delivery_driver/features/my_account/domain/models/wallet_payment_model.dart';
...
class MyAccountController extends GetxController implements GetxService {
  ...
  Future<Response> convertPoint(String point) async {
    _isLoading = true;
    update();
    Response response = await myAccountServiceInterface.convertPoint(point);
    if (response.statusCode == 200) {
