            ...
            child: SingleChildScrollView(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index){
                  ...
                  bool isSelected = myAccountController.paymentIndex == 1 && Get.find<SplashController>().configModel!.activePaymentMethodList![index].getWay! == myAccountController.digitalPaymentName;

                  return InkWell(
                    onTap: (){
                      myAccountController.setPaymentIndex(1);
                      myAccountController.changeDigitalPaymentName(Get.find<SplashController>().configModel!.activePaymentMethodList![index].getWay!);
                    },
                    child: Container(
            ...
            child: Padding(
              ...
              child: CustomButtonWidget(
                ...
                onPressed: () {
                  ...
                  myAccountController.makeCollectCashPayment(amount, myAccountController.digitalPaymentName!);
                }
              ),
            ),
          ),
