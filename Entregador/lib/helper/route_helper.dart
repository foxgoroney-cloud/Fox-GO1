...
import 'package:fox_delivery_driver/features/auth/screens/dm_registration_success_screen.dart';
import 'package:fox_delivery_driver/features/disbursement/domain/models/disbursement_method_model.dart';
import 'package:fox_delivery_driver/features/my_account/screens/edit_withdraw_method_screen.dart';
import 'package:fox_delivery_driver/features/my_account/screens/my_earning_filter_screen.dart';
import 'package:fox_delivery_driver/features/my_account/screens/my_earning_screen.dart';
...
import 'package:fox_delivery_driver/features/auth/screens/sign_in_screen.dart';
import 'package:fox_delivery_driver/features/auth/screens/dm_registration_screen.dart';
import 'package:fox_delivery_driver/features/my_account/screens/my_account_screen.dart';
import 'package:fox_delivery_driver/features/my_account/screens/transaction_history_screen.dart';
import 'package:fox_delivery_driver/features/my_account/screens/wallet_provided_earning_history_screen.dart';
import 'package:fox_delivery_driver/features/my_account/screens/payment_screen.dart';
import 'package:fox_delivery_driver/features/my_account/widgets/payment_successful_widget.dart';
import 'package:fox_delivery_driver/features/chat/screens/chat_screen.dart';
import 'package:fox_delivery_driver/features/chat/screens/conversation_screen.dart';
import 'package:fox_delivery_driver/features/dashboard/screens/dashboard_screen.dart';
import 'package:fox_delivery_driver/features/my_account/screens/add_withdraw_method_screen.dart';
import 'package:fox_delivery_driver/features/disbursement/screens/disbursement_screen.dart';
import 'package:fox_delivery_driver/features/my_account/screens/withdraw_method_screen.dart';
import 'package:fox_delivery_driver/features/forgot_password/screens/forget_pass_screen.dart';
import 'package:fox_delivery_driver/features/forgot_password/screens/new_pass_screen.dart';
import 'package:fox_delivery_driver/features/forgot_password/screens/verification_screen.dart';
import 'package:fox_delivery_driver/features/html/screens/html_viewer_screen.dart';
import 'package:fox_delivery_driver/features/notification/screens/notification_screen.dart';
import 'package:fox_delivery_driver/features/order/screens/delivery_operation_screen.dart';
import 'package:fox_delivery_driver/features/order/screens/order_details_screen.dart';
import 'package:fox_delivery_driver/features/profile/screens/update_profile_screen.dart';
import 'package:fox_delivery_driver/features/home/screens/permission_onboarding_screen.dart';
import 'package:fox_delivery_driver/features/splash/screens/splash_screen.dart';
import 'package:fox_delivery_driver/features/update/screens/update_screen.dart';
...
class RouteHelper {
  ...
  static const String deliveryOperation = '/delivery-operation';
  ...
  static String getChatRoute({
    ...
    if (notificationBody != null) {
      notificationBody0 = base64Encode(
        utf8.encode(jsonEncode(notificationBody)),
      );
    }
    if (user != null) {
  ...
  static String getDeliveryOperationRoute(int orderId) =>
      '$deliveryOperation?order_id=$orderId';
  static String getPermissionOnboardingRoute() => permissionOnboarding;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
      name: main,
      page: () {
        final int pageIndex = Get.parameters['page'] == 'home'
            ? 0
            ...
            ? 3
            : 0;
        final int? initialIncomingOrderId = int.tryParse(
          Get.parameters['order_id'] ?? '',
        );
        return DashboardScreen(
          pageIndex: pageIndex,
          initialIncomingOrderId: initialIncomingOrderId,
        );
      },
    ),
        ...
        if (Get.parameters['notification_body'] != 'null') {
          notificationBody = NotificationBodyModel.fromJson(
            jsonDecode(
              utf8.decode(
                base64Url.decode(
                  Get.parameters['notification_body']!.replaceAll(' ', '+'),
                ),
              ),
            ),
          );
    ...
    GetPage(
      ...
      page: () => const DmRegistrationScreen(),
    ),
    ...
    GetPage(
      ...
      page: () {
        Methods method = Methods.fromJson(
          jsonDecode(
            utf8.decode(
              base64Url.decode(Get.parameters['method']!.replaceAll(' ', '+')),
            ),
          ),
        );
